...
#===================================================================================
   ...
   # clear;
	echo "Creamos el usuario Yolo";
	sudo mysql -u root -e "CREATE USER 'yolo'@'localhost' IDENTIFIED BY '12345'";
	echo "Copia de seguridad";
	 sudo cp /etc/mysql/my.cnf /etc/mysql/my.cnf.bak;
	echo "Este proceso puede tardar varios minutos..." | boxes;
	sudo mysqld --skip-grant-tables;
	#sudo mysql -u root -e "UPDATE user SET Password=PASSWORD('12345') WHERE USER='yolo'";
	sudo mysql -u root -e "GRANT ALL PRIVILEGES ON * . * TO 'yolo'@'localhost'";
...
#===================================================================================
	...
	sudo rm /etc/apache2/mods-enabled/dir.conf;
    	...
    	sudo cp repositorio_git/Script/Archivos_configuracion/dir.conf /etc/apache2/mods-enabled/dir.conf;
	#Mover el index.php al directorio /var/www/html/
	echo "Movemos el contenido de la carpeta reto"	
	sudo cp -r repositorio_git/src/RETO/* /var/www/html/;
...
#===================================================================================
	...
	sudo cp repositorio_git/Script/Archivos_configuracion/000-default.conf /etc/apache2/sites-available/;
...
#===================================================================================
	...
	sudo cp repositorio_git/Script/Archivos_configuracion/hosts /etc/hosts;
...
#===================================================================================
	...
	sudo cp -r repositorio_git/Script/Archivos_configuracion/ssl/ /etc/apache2/;
	...
	sudo cp repositorio_git/Script/Archivos_configuracion/default-ssl.conf /etc/apache2/sites-available/default-ssl.conf;
